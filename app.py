...
@st.cache_resource
def carrega_modelo():
    #https://drive.google.com/file/d/1c2r8KhXlLqi5d3yq3L2ZYu41Z2vKejpe/view?usp=drive_link
    url='https://drive.google.com/uc?id=1c2r8KhXlLqi5d3yq3L2ZYu41Z2vKejpe'

    gdown.download(url, 'modelo_lite_quantizado.tflite')
    interpreter=tf.lite.Interpreter(model_path='modelo_lite_quantizado.tflite')
